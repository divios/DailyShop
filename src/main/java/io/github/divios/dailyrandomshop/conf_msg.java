...
public class conf_msg {
    ...
    public static void init() {
        ...
        ADD_ITEMS_FROM_EXISTING = FormatUtils.color(yamlFile.getString("add-items-from-existing", "&a&lCreate item from existing"));
        ...
        DAILY_ITEMS_MENU_RETURN = FormatUtils.color(yamlFile.getString("daily-items-menu_return", "&c&lReturn"));
        DAILY_ITEMS_MENU_ITEMS_LORE = yamlFile.getStringList("daily-items-menu-items-lore");
        DAILY_ITEMS_MENU_ANVIL_TITLE = FormatUtils.color(yamlFile.getString("daily-items-anvil-title", "&6&lSet Price"));
        DAILY_ITEMS_MENU_ANVIL_DEFAULT_TEXT = FormatUtils.color(yamlFile.getString("daily-items-anvil-default-text", "Price"));

        SELL_ITEMS_MENU_TITLE = FormatUtils.color(yamlFile.getString("sell-items-menu_title", "&6&lsell items Manager"));
        SELL_ITEMS_MENU_NEXT = FormatUtils.color(yamlFile.getString("sell-items-menu_next", "&6&lNext"));
        SELL_ITEMS_MENU_PREVIOUS = FormatUtils.color(yamlFile.getString("sell-items-menu_previous", "&6&lPrevious"));
        SELL_ITEMS_MENU_RETURN = FormatUtils.color(yamlFile.getString("sell-items-menu_return", "&c&lReturn"));
        SELL_ITEMS_MENU_ITEMS_LORE = yamlFile.getStringList("sell-items-menu-items-lore");
        SELL_ITEMS_MENU_ANVIL_TITLE = FormatUtils.color(yamlFile.getString("sell-items-anvil-title", "&6&lSet Price"));
        SELL_ITEMS_MENU_ANVIL_DEFAULT_TEXT = FormatUtils.color(yamlFile.getString("sell-items-anvil-default-text", "Price"));

        CUSTOMIZE_GUI_TITLE = FormatUtils.color(yamlFile.getString("customize_menu_title", "&a&lCustomize Item"));
        CUSTOMIZE_CRAFT = FormatUtils.color(yamlFile.getString("customize_craft", "&a&lCraft item"));
        CUSTOMIZE_CRAFT_LORE = yamlFile.getStringList("customize_craft_lore");
        CUSTOMIZE_RETURN = FormatUtils.color(yamlFile.getString("customize_return", "&c&lReturn"));
        CUSTOMIZE_RETURN_LORE = yamlFile.getStringList("customize_return_lore");
        CUSTOMIZE_CHANGE_ECON = FormatUtils.color(yamlFile.getString("customize_change_econ", "&f&lChange currency"));
        CUSTOMIZE_CHANGE_ECON_LORE = yamlFile.getStringList("customize_change_econ_lore");
        CUSTOMIZE_CHANGE_CONFIRM_GUI = FormatUtils.color(yamlFile.getString("customize_change_confirm_gui", "&aEnable/disable confirm Gui"));
        CUSTOMIZE_CHANGE_CONFIRM_GUI_LORE = yamlFile.getStringList("customize_change_confirm_gui_lore");
        CUSTOMIZE_PERMS = FormatUtils.color(yamlFile.getString("customize_perms", "&f&lEdit permissions"));
        ...
        CUSTOMIZE_SET = FormatUtils.color(yamlFile.getString("customize_set", "&f&lEdit set"));
        ...
        CUSTOMIZE_RENAME = FormatUtils.color(yamlFile.getString("customize_rename", "&f&lRename"));
        CUSTOMIZE_RENAME_LORE = yamlFile.getStringList("customize_rename_lore");
        CUSTOMIZE_MATERIAL = FormatUtils.color(yamlFile.getString("customize_change_material", "&f&lChange Material"));
        CUSTOMIZE_MATERIAL_LORE = yamlFile.getStringList("customize_change_material_lore");
        CUSTOMIZE_SEARCH = FormatUtils.color(yamlFile.getString("customize_search", "&b&lSearch"));
        CUSTOMIZE_SEARCH_LORE = yamlFile.getStringList("customize_search_lore");
        CUSTOMIZE_CANCEL_SEARCH = FormatUtils.color(yamlFile.getString("customize_cancel_search", "&c&lCancel search"));
        CUSTOMIZE_CANCEL_SEARCH_LORE = yamlFile.getStringList("customize_cancel_search_lore");
        CUSTOMIZE_LORE = FormatUtils.color(yamlFile.getString("customize-change_lore", "&f&lChange Lore"));
        CUSTOMIZE_LORE_LORE = yamlFile.getStringList("customize_change_lore_lore");
        CUSTOMIZE_ENCHANTS = FormatUtils.color(yamlFile.getString("customize_change_enchants", "&f&lEdit enchantments"));
        CUSTOMIZE_ENCHANTS_LORE = yamlFile.getStringList("customize_change_enchants_lore");
        CUSTOMIZE_AMOUNT = FormatUtils.color(yamlFile.getString("customize_change_amount", "&f&lChange Amount"));
        CUSTOMIZE_AMOUNT_ENABLE_LORE = yamlFile.getStringList("customize_enable_amount_lore");
        CUSTOMIZE_BUNDLE = FormatUtils.color(yamlFile.getString("customize_bundle", "&f&lChange item Durability"));
        CUSTOMIZE_BUNDLE_LORE = yamlFile.getStringList("customize_bundle_lore");
        CUSTOMIZE_DURABILITY = FormatUtils.color(yamlFile.getString("customize_change-durability", "&f&lChange Bundle item"));
        ...
        CUSTOMIZE_ENABLE_COMMANDS = FormatUtils.color(yamlFile.getString("customize_enable_commands", "&f&lSet Item Reward as Commands"));
        CUSTOMIZE_ENABLE_COMMANDS_LORE = yamlFile.getStringList("customize_enable_commands_lore");
        CUSTOMIZE_CHANGE_COMMANDS = FormatUtils.color(yamlFile.getString("customize_change_commands", "&f&lSet commands to run"));
        CUSTOMIZE_CHANGE_COMMANDS_LORE = yamlFile.getStringList("customize_change_commands_lore");
        CUSTOMIZE_TOGGLE_ENCHANTS = FormatUtils.color(yamlFile.getString("customize_toggle_enchants", "&f&lMake enchant visible/invisible"));
        CUSTOMIZE_TOGGLE_ENCHANTS_LORE = yamlFile.getStringList("customize_toggle_enchants_lore");
        CUSTOMIZE_TOGGLE_ATTRIBUTES = FormatUtils.color(yamlFile.getString("customize_toggle_attributes", "&f&lMake attributes visible/invisible"));
        CUSTOMIZE_TOGGLE_ATTRIBUTES_LORE = yamlFile.getStringList("customize_toggle_attributes_lore");
        CUSTOMIZE_TOGGLE_EFFECTS = FormatUtils.color(yamlFile.getString("customize_toggle_effects", "&f&lMake potion effects visible/invisible"));
        CUSTOMIZE_TOGGLE_EFFECTS_LORE = yamlFile.getStringList("customize_toggle_effects_lore");
        CUSTOMIZE_RENAME_ANVIL_TITLE = FormatUtils.color(yamlFile.getString("customize_rename_anvil_title", "&6&lInput the new lore"));
        CUSTOMIZE_RENAME_ANVIL_DEFAULT_TEXT = FormatUtils.color(yamlFile.getString("customize_rename_anvil_default_text", "Write the new name"));
        CUSTOMIZE_CHANGE_LORE_TITLE = FormatUtils.color(yamlFile.getString("customize_change_lore_anvil_title", "&6&lWrite lore"));
        CUSTOMIZE_CHANGE_LORE_DEFAULT_TEXT = FormatUtils.color(yamlFile.getString("customize_change_lore_default_text", "Write lore"));
        CUSTOMIZE_ADD_COMMANDS_TITLE = FormatUtils.color(yamlFile.getString("customize_add_commands_anvil_title", "&6&lWrite command to be added"));
        CUSTOMIZE_ADD_COMMANDS_DEFAULT_TEXT = FormatUtils.color(yamlFile.getString("customize_add_commands_default_text", "Write command to be added"));
        CUSTOMIZE_UNAVAILABLE = FormatUtils.color(yamlFile.getString("customize_unavailable_item", "&c&lUNAVAILABLE"));

        MSG_OPEN_SHOP = FormatUtils.color(yamlFile.getString("message-open-shop", "&7Opening daily shop..."));
        MSG_BUY_ITEM = FormatUtils.color(yamlFile.getString("message-buy-item", "&7You bought the item {item} for {price}"));
